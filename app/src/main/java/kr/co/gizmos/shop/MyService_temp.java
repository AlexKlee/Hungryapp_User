...
public class MyService_temp extends Service implements LocationListener {
    ...
    public static String str_receiver= "MyService_temp.service.receiver";//??
    Intent intent;

    public MyService_temp(){
